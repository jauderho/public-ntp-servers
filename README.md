...
**WARNING:** Server availability and accuracy can vary. Always verify servers before relying on them for critical applications. Visit the companion repo of [NTP servers with NTS support](https://github.com/jauderho/nts-servers/e).
